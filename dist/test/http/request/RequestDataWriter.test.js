...
describe('RequestDataWriter', function () {
    it('extends RequestDataReader', function () {
        const writer = new RequestDataWriter_1.RequestDataWriter({});
        expect(writer).toBeInstanceOf(RequestDataReader_1.RequestDataReader);
    });
    ...
    describe('.pull()', function () {
        it('calls .get() to get data, calls .delete() to delete path and returns the value', function () {
            const writer = new RequestDataWriter_1.RequestDataWriter({ a: 1, b: { c: 2, d: 3 } });
    ...
    describe('.clear()', function () {
        ...
        it('set this.data to new Object', function () {
            const writer = new RequestDataWriter_1.RequestDataWriter({ test: 0 });
            writer.clear();
