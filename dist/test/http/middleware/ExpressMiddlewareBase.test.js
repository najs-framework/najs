...
describe('ExpressMiddlewareBase', function () {
    describe('constructor()', function () {
        it('sets the first param to name, call .parseLevel(), .parseParams(), .parseIdentify()', function () {
            const parseLevelSpy = Sinon.spy(ExpressMiddlewareBase_1.ExpressMiddlewareBase.prototype, 'parseLevel');
            const parseParamsSpy = Sinon.spy(ExpressMiddlewareBase_1.ExpressMiddlewareBase.prototype, 'parseParams');
            const parseIdentifySpy = Sinon.spy(ExpressMiddlewareBase_1.ExpressMiddlewareBase.prototype, 'parseIdentify');
            const instance = new ExpressMiddlewareBase_1.ExpressMiddlewareBase('test', 'a');
    ...
    describe('.native()', function () {
        it('returns undefined if the .createMiddleware() return undefined', function () {
            ...
            expect(instance.native({})).toBe(undefined);
        });
        it('returns result of .createMiddleware() if "isAppLevel" = false', function () {
            const instance = new ExpressMiddlewareBase_1.ExpressMiddlewareBase('test');
            const createMiddlewareStub = Sinon.stub(instance, 'createMiddleware');
            createMiddlewareStub.returns('any');
            expect(instance.native({})).toBe('any');
        });
        it('always returns "undefined" if "isAppLevel" is true', function () {
            ...
            const instance = new ExpressMiddlewareBase_1.ExpressMiddlewareBase('test', 'global');
            const createMiddlewareStub = Sinon.stub(instance, 'createMiddleware');
            createMiddlewareStub.returns('any');
            expect(instance.native(driver)).toBeUndefined();
        });
