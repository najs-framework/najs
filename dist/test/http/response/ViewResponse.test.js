...
describe('ViewResponse', function () {
    it('implements contract Najs.Contracts.Response with class name Najs.Http.Response.ViewResponse', function () {
        const response = new ViewResponse_1.ViewResponse('view');
        expect(response.getClassName()).toEqual('Najs.Http.Response.ViewResponse');
    });
